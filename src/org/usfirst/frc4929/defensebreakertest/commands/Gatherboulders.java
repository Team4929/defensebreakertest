 ...
 *
 */
public class Gatherboulders extends Command {
    ...
    protected void execute() {
    	...
    	try {
        	...
        	while (!isFinished()) {
        		Robot.boulderGrabber.startGatherer();
        	}
    	}  finally {
    		timer.stop();
    	}
    ...
    protected void end() {
    	Robot.boulderGrabber.stopGatherer();
    }
